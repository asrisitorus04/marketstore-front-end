  ...
  return (
    <div className="w-52 p-4 flex flex-col items-center gap-2 border-2 border-primary rounded-2xl shadow-lg bg-white hover:brightness-110 cursor-pointer">
      ...
      <div className="flex flex-col gap-0 text-center">
        <p className="font-semibold" onClick={onNavigate}>
          {name}
        </p>
      ...
      <button
        className="w-full p-1 rounded-md font-bold text-white bg-primary border-2 border-primary hover:bg-white hover:text-primary "
...
function PurchaseHisCard() {
  return (
    <div className="w-full flex justify-center">
      <div className="p-2 flex items-center justify-start gap-10">
        <img
...
function ItemCart({ item }) {
  return (
    <>
      {item.map((data) => (
        <div key={data.id_product} className="w-full flex">
          <div className="w-full flex items-center justify-between p-2 gap-6 border-2 rounded-lg shadow-md">
            <div className="w-full flex items-center gap-6">
              ...
              <div className="flex flex-col gap-1">
                <p className="text-lg font-bold">{data.name_product}</p>
